...
import {EventSeatingSettings, EventTablePosition, EventTableType, GenericDataResponse, IdParam} from '../types';
...
export const eventSeatingClient = {
    ...
    update: async (eventId: IdParam, settings: {table_types: EventTableType[]}) => {
